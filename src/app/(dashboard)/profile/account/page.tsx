...
export default async function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <section>
        <h2 className="mb-2 text-sm font-semibold text-gray-900">계정 정보</h2>
      ...
      <section>
        <h2 className="mb-2 text-sm font-semibold text-gray-900">비밀번호 변경</h2>
        {hasPassword ? (
          <ChangePasswordForm />
        ) : (
      ...
      <section>
        <h2 className="mb-2 text-sm font-semibold text-gray-900">구독/결제</h2>
        <div className="space-y-2 rounded-md border border-gray-200 p-4 text-sm">
          ...
          <Link href="/billing" className="inline-block text-sm font-medium text-gray-900 underline">
            요금제 페이지로 이동
          </Link>
        </div>
      </section>
